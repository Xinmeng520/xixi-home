...
// SVG icon paths - all 24x24 viewBox, stroke-based
const ICON_PATHS: Record<string, string> = {
  ...
  pin: '<path d="M12 17v5"/><path d="M9 10.76V5a2 2 0 0 1 2-2h2a2 2 0 0 1 2 2v5.76"/><path d="M5 10.76h14l-1.45 7.24a2 2 0 0 1-2 1.62H8.45a2 2 0 0 1-2-1.62L5 10.76z"/>',
  'pin-off': '<path d="M12 17v5"/><path d="M9 10.76V5a2 2 0 0 1 2-2h2a2 2 0 0 1 2 2v5.76"/><path d="M5 10.76h14l-1.45 7.24a2 2 0 0 1-2 1.62H8.45a2 2 0 0 1-2-1.62L5 10.76z"/><line x1="2" y1="2" x2="22" y2="22"/>',
  ...
  logo: '<path d="M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z"/>',
  ...
  'album-filled': '<rect x="3" y="3" width="18" height="18" rx="2" ry="2"/><circle cx="8.5" cy="8.5" r="1.5"/><polyline points="21 15 16 10 5 21"/>',
...
export default function Icon({ name, size = 24, color = 'currentColor', className = '' }: IconProps) {
  ...
  const svg = '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="' + size + '" height="' + size + '" fill="none" stroke="' + color + '" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">' + path + '</svg>'
