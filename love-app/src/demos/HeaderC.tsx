...
function HeaderC() {
  ...
  return (
    <div className="relative bg-gradient-to-br from-warm-500 via-warm-400 to-warm-300 pt-10 pb-12 overflow-hidden">
      {/* Subtle pattern overlay */}
      <div className="absolute inset-0 opacity-10">
        <div className="absolute top-6 left-8 w-24 h-24 border border-white rounded-full"></div>
        <div className="absolute top-10 left-12 w-16 h-16 border border-white rounded-full"></div>
        <div className="absolute top-4 right-6 w-20 h-20 border border-white rounded-full"></div>
      </div>

      {/* Top bar */}
      <div className="relative flex items-center justify-between px-5 mb-5">
      ...
      {/* Stats row */}
      <div className="relative flex items-center justify-center gap-8 px-5">
        <div className="flex items-center gap-2">
          ...
          <div>
            <p className="text-white text-xl font-bold leading-none">{days}<span className="text-xs font-normal opacity-70"> 天</span></p>
            <p className="text-white/60 text-[10px] mt-0.5">在一起</p>
          </div>
        </div>
        ...
        <div className="flex items-center gap-2">
          ...
          <div>
            <p className="text-white text-xl font-bold leading-none">{nextEvent.daysLeft}<span className="text-xs font-normal opacity-70"> 天</span></p>
            <p className="text-white/60 text-[10px] mt-0.5">{nextEvent.name}</p>
          </div>
        </div>
      </div>
      ...
      <svg className="absolute bottom-0 left-0 w-full" viewBox="0 0 390 40" preserveAspectRatio="none">
        <path d="M0,20 C98,40 292,0 390,20 L390,40 L0,40 Z" fill="#f9fafb"/>
      </svg>
    </div>
  );
}
...
export default function DemoB_HeaderC() {
  return (
