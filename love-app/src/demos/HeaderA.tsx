...
function HeaderA() {
  ...
  return (
    <div className="relative bg-gradient-to-br from-warm-400 via-warm-500 to-warm-600 px-5 pt-10 pb-8 rounded-b-[2rem] overflow-hidden">
      {/* Floating circles decoration */}
      <div className="absolute top-4 right-6 w-16 h-16 rounded-full bg-white/10 blur-sm"></div>
      <div className="absolute top-16 right-20 w-8 h-8 rounded-full bg-white/10"></div>
      <div className="absolute -top-4 left-10 w-20 h-20 rounded-full bg-white/5 blur-md"></div>
      <div className="absolute bottom-8 left-4 w-10 h-10 rounded-full bg-white/8"></div>
      <div className="absolute top-8 left-1/3 w-6 h-6 rounded-full bg-white/10"></div>
      ...
      <div className="relative flex items-center justify-center gap-6">
        <div className="flex flex-col items-center">
          <div className="w-20 h-20 rounded-full bg-white/20 backdrop-blur-sm flex items-center justify-center border border-white/20 shadow-lg">
            <div className="text-center">
              <p className="text-white text-2xl font-bold leading-none">{days}</p>
              <p className="text-white/70 text-[10px] mt-0.5">天</p>
            </div>
          </div>
          <p className="text-white/80 text-[11px] mt-2">在一起</p>
        </div>
        ...
        <div className="flex flex-col items-center">
          <div className="w-20 h-20 rounded-full bg-white/20 backdrop-blur-sm flex items-center justify-center border border-white/20 shadow-lg">
            <div className="text-center">
              <p className="text-white text-2xl font-bold leading-none">{nextEvent.daysLeft}</p>
              <p className="text-white/70 text-[10px] mt-0.5">天</p>
            </div>
          </div>
          <p className="text-white/80 text-[11px] mt-2">{nextEvent.name}</p>
        </div>
      </div>
    </div>
  );
...
export default function DemoB_HeaderA() {
  return (
