...
export default function AnniversaryPage() {
  ...
  return (
    <div className="px-4 pt-4 pb-6">
      ...
      : items.length === 0 ? (<div className="bg-white rounded-2xl p-8 shadow-sm text-center"><p className="text-sm text-gray-400">还没有纪念日</p><p className="text-xs text-gray-300 mt-1">点击右上角添加</p></div>)
